...
Qv2rayKernelPluginObject *SimplePlugin::GetKernelInstance()
{
...
bool SimplePlugin::InitializePlugin(const QString &, const QJsonObject &settings)
{
...
Qv2rayPluginEditorWidget *SimplePlugin::GetEditorWidget(QV2RAY_PLUGIN_UI_TYPE type)
{
...
QV2RAY_PLUGIN_PROCESSTYPE_FLAGS SimplePlugin::PluginHooks() const
{
    emit PluginLog("Getting Plugin Hook.");
    // We want all events!
    return { PROCESSTYPE_NONE,         //
             PROCESSTYPE_STATS,        //
             PROCESSTYPE_ITEM,         //
...
QV2RAY_SPECIAL_PLUGIN_TYPE_FLAGS SimplePlugin::SpecialPluginType() const
{
